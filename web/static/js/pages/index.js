...
let vehicle = [
   {vehicle_id: 1, vehicle_title: 'Fiesta', vehicle_plate: 'HDO1775', vehicle_type: 'Hatch', vehicle_year: 2008, vehicle_manufacturer: 'Ford', vehicle_photo: ''},
   {vehicle_id: 2, vehicle_title: 'Fusion', vehicle_plate: 'HDO2375', vehicle_type: 'Sedan', vehicle_year: 2014, vehicle_manufacturer: 'Ford', vehicle_photo: ''},
   {vehicle_id: 3, vehicle_title: 'Umbrela', vehicle_plate: 'HDO1234', vehicle_type: 'Pickup', vehicle_year: 2015, vehicle_manufacturer: 'Ford', vehicle_photo: ''},
   {vehicle_id: 4, vehicle_title: 'Vocation', vehicle_plate: 'HDO1545', vehicle_type: 'Hatch', vehicle_year: 2010, vehicle_manufacturer: 'Ford', vehicle_photo: ''},
   {vehicle_id: 5, vehicle_title: 'BAT MOVEL', vehicle_plate: 'XXXXXX', vehicle_type: 'TOOP', vehicle_year: 2020, vehicle_manufacturer: 'Author not found', vehicle_photo: ''}
];
...
spa.onNavigate('', (page, params) => {
   ...
   vehicle.forEach(function(element, index){
      ...
      // *Spans:
      let vehicle_title = $('<span>').addClass('primary').text(element.vehicle_title+" - "+element.vehicle_plate).appendTo(vertical_layout_div);
      $('<br>').appendTo(vehicle_title);
      let vehicle_description = $('<span>').addClass('secondary').text(element.vehicle_year+" - "+element.vehicle_type+" - "+element.vehicle_manufacturer).appendTo(vertical_layout_div);
